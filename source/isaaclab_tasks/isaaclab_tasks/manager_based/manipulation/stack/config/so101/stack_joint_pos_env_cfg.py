...
class EventCfg:
    ...
    init_so101_arm_pose = EventTerm(
        ...
        mode="reset",
        params={
            # Default pose for SO-101 ARM based on your joint names
            "default_pose": [0.0, -0.5, 0.0, -1.5, 0.0, 0.02],  # [Rotation, Pitch, Elbow, Wrist_Pitch, Wrist_Roll, Jaw]
        },
    )
...
class SO101CubeStackEnvCfg(StackEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Set actions for the specific robot type (SO-101)
        ...
        # Frame transformer for SO-101 (adjust link names based on your robot's URDF/USD)
        self.scene.ee_frame = FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/Robot/base_link",  # Adjust to your robot's base link
            debug_vis=False,
            visualizer_cfg=marker_cfg,
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/gripper_link",  # Adjust to your robot's gripper link
                    name="end_effector",
                    offset=OffsetCfg(
